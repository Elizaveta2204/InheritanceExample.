// example 2.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
{
	setlocale(0, "ru");
	animal an = animal("Паук", 0.003, 0.05);
	cout << an.get_mass() << endl;
